...
export const MatchExperienceLazy = dynamic(
  () =>
    import('@/components/match/premium/MatchExperience').then((m) => ({
      default: m.MatchExperience,
    })),
  { ssr: false, loading: () => <FullscreenSkeleton /> },
);
...
export const ListingDetailModalLazy = dynamic(
  () =>
    import('@/components/market/ListingDetailModal').then((m) => ({
      default: m.ListingDetailModal,
    })),
  { ssr: false, loading: () => <ModalSkeleton /> },
);
...
export const NotificationDrawerLazy = dynamic(
  () =>
    import('@/components/notifications/NotificationDrawer').then((m) => ({
      default: m.NotificationDrawer,
    })),
  { ssr: false, loading: () => null },
);
...
export const LeaderboardExperienceLazy = dynamic(
  () =>
    import('@/components/ranking/LeaderboardExperience').then((m) => ({
      default: m.LeaderboardExperience,
    })),
  { ssr: false, loading: () => <PanelSkeleton /> },
);

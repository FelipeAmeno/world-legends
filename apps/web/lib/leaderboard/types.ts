...
export type LeaderboardEntry = {
  ...
  // Visual
  readonly topCard?:   {            // melhor carta (para OVR leaderboard)
    name:        string;
    ovr:         number;
    rarityCode:  string;
  };

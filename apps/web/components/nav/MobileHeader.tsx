...
const NAV_ICONS: Record<string, string | string[]> = {
  ...
  '/match': [
    ...
    'M4.93 4.93l4.24 4.24m5.66 5.66 4.24 4.24',
  ],
  '/missions': 'M12 22c5.52 0 10-4.48 10-10S17.52 2 12 2 2 6.48 2 12s4.48 10 10 10z M12 8v4l3 3',
  ...
  '/rewards': ['M20 12v10H4V12', 'M2 7h20v5H2z', 'M12 22V7'],
  '/settings':

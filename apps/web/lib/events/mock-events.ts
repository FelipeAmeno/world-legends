...
import type { EventRewardItem, GameEvent } from './types';

// ─── Helpers de recompensa ────────────────────────────────────────────────────

const xp = (amount: number): EventRewardItem => ({
  kind: 'xp',
  amount,
  label: `+${amount} XP`,
  icon: '⭐',
});
const credits = (amount: number): EventRewardItem => ({
  kind: 'credits',
  amount,
  label: `+${amount}c`,
  icon: '💰',
...
export const MOCK_EVENTS: GameEvent[] = [
    ...
    rewardTiers: [
      ...
      },
      {
        ...
        items: [
          xp(10000),
          credits(8000),
          pack('legend', 'Legend Pack'),
          card('wch-exclusive', 'World Cup Hero Exclusivo'),
  ...
  // ── 2. Champions League ───────────────────────────────────────────────────────
  {
    ...
    rewardTiers: [
      { tier: 'Participação', icon: '🏅', color: 'text-white/50', items: [xp(400), credits(150)] },
      {
        ...
        icon: '🥉',
        color: 'text-amber-600',
        items: [xp(800), credits(400), frags(30)],
        maxRank: 15923,
      },
      {
        tier: 'Top 25%',
        icon: '🥈',
        color: 'text-slate-300',
        items: [xp(1800), credits(900), pack('classic', 'Classic Pack')],
        maxRank: 7961,
      },
      {
        tier: 'Top 10%',
        icon: '🥇',
        color: 'text-yellow-400',
        items: [xp(3000), credits(2000), pack('elite', 'Elite Pack')],
        maxRank: 3184,
      },
      {
        tier: 'Campeão',
  ...
  // ── 3. Libertadores ───────────────────────────────────────────────────────────
  {
    ...
    rewardTiers: [
      { tier: 'Participação', icon: '🏅', color: 'text-white/50', items: [xp(300), credits(100)] },
      {
        ...
        icon: '🥉',
        color: 'text-amber-600',
        items: [xp(700), credits(350), frags(20)],
        maxRank: 11054,
      },
      {
        tier: 'Top 25%',
        icon: '🥈',
        color: 'text-slate-300',
        items: [xp(1500), credits(800), pack('classic', 'Classic Pack')],
        maxRank: 5527,
      },
      {
        tier: 'Top 10%',
        icon: '🥇',
        color: 'text-yellow-400',
        items: [xp(2500), credits(1800), pack('elite', 'Elite Pack')],
        maxRank: 2210,
      },
      {
        tier: 'Campeão',
        ...
        items: [
          ...
          credits(5000),
          pack('legend', 'Legend Pack'),
          badge('Rei das Américas'),
          title('Rei das Américas'),
        ],
        maxRank: 1,
      },
    ],
  ...
  // ── 4. Copa América ───────────────────────────────────────────────────────────
  {
    ...
    rewardTiers: [
      ...
      },
      {
        ...
        icon: '🥇',
        color: 'text-yellow-400',
        items: [xp(2000), credits(1500), pack('elite', 'Elite Pack')],
        maxRank: 1544,
      },
      {
        tier: 'Campeão',
  ...
  // ── 5. Desafio Semanal ────────────────────────────────────────────────────────
  {
    ...
    requirements: [{ kind: 'min_level', value: 2, label: 'Nível 2 ou superior' }],
    ...
    rewardTiers: [
      { tier: 'Participação', icon: '🏅', color: 'text-white/50', items: [xp(200), credits(100)] },
      {
        ...
        icon: '🥉',
        color: 'text-amber-600',
        items: [xp(500), credits(250), frags(25)],
        maxRank: 4117,
      },
      {
        tier: 'Top 10%',
        icon: '🥇',
        color: 'text-yellow-400',
        items: [xp(1200), credits(800), pack('classic', 'Classic Pack')],
        maxRank: 823,
      },
    ],
  },
  ...
  // ── 6. Desafio Diário ─────────────────────────────────────────────────────────
  {
    ...
    requirements: [{ kind: 'min_level', value: 1, label: 'Qualquer nível' }],
    ...
    rewardTiers: [
      {
        ...
        icon: '🎯',
        color: 'text-pink-400',
        items: [xp(150), credits(75), frags(10)],
      },
    ],
  },
  ...
  // ── 7. Eurocopa ───────────────────────────────────────────────────────────────
  {
    ...
    description: 'Em breve! Prepare seu squad europeu e esteja pronto quando a Eurocopa começar.',
    banner: {
      from: '#000d3a',
      via: '#1e3a8a',
      to: '#1d4ed8',

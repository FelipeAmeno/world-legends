...
export const ALL_CARDS: MockCard[] = [
  // ── Ultras ──────────────────────────────────────────────────────────────────
  {
    ...
    competition: 'laliga',
    era: '1990s',
    traits: ['clinical_finisher', 'pace_monster'],
    evolution: 2,
    contracts: 5,
    stamina: 88,
    physical: 92,
  },
  {
    ...
    competition: 'laliga',
    era: '2000s',
    traits: ['dribble_master', 'clutch_performer'],
    evolution: 1,
    contracts: 7,
    stamina: 85,
    physical: 80,
  ...
  },
  {
    ...
    era: '1960s',
    traits: ['clinical_finisher', 'clutch_performer'],
    evolution: 3,
    contracts: 4,
    stamina: 90,
    physical: 88,
  ...
  // ── Legendaries ─────────────────────────────────────────────────────────────
  {
    ...
    competition: 'brasileirao',
    era: '1980s',
    traits: ['playmaker', 'set_piece_specialist'],
    evolution: 1,
    contracts: 6,
    stamina: 80,
    physical: 75,
  ...
  },
  {
    ...
    competition: 'laliga',
    era: '1990s',
    traits: ['rocket_shot', 'stamina_boost'],
    evolution: 2,
    contracts: 2,
    stamina: 94,
    physical: 85,
  },
  {
    ...
    competition: 'serie_a',
    era: '1990s',
    traits: ['stamina_boost', 'pace_monster'],
    evolution: 0,
    contracts: 7,
    stamina: 95,
    physical: 84,
  },
  {
    ...
    competition: 'laliga',
    era: '1990s',
    traits: ['clutch_performer', 'rocket_shot'],
    evolution: 1,
    contracts: 5,
    stamina: 82,
    physical: 78,
  ...
  },
  {
    ...
    competition: 'serie_a',
    era: '1990s',
    traits: ['aerial_threat', 'brick_wall'],
    evolution: 1,
    contracts: 7,
    stamina: 78,
    physical: 86,
  },
  {
    ...
    competition: 'brasileirao',
    era: '1990s',
    traits: ['reflexes', 'penalty_stopper'],
    evolution: 0,
    contracts: 7,
    stamina: 80,
    physical: 76,
  },
  {
    ...
    competition: 'serie_a',
    era: '2000s',
    traits: ['physical_beast', 'rocket_shot'],
    evolution: 0,
    contracts: 4,
    stamina: 77,
    physical: 92,

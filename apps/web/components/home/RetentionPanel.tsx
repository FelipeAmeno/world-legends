      ...
      <div className="grid grid-cols-2 gap-3">
        ...
        <motion.button
          ...
          style={{
            ...
            borderColor: state.canClaimToday
              ? 'rgba(201,168,76,0.35)'
              : 'rgba(255,255,255,0.07)',
            boxShadow: state.canClaimToday
        ...
        >
          ...
          {!state.canClaimToday && nextDayEntry && (
            <div className="mt-2 flex items-center gap-1.5 px-2 py-1 rounded-lg" style={{ background: 'rgba(255,255,255,0.04)' }}>
              <span style={{ fontSize: 12 }}>{nextRewardIcon}</span>
              <p style={{ fontSize: 8, color: 'rgba(255,255,255,0.35)' }}>Amanhã: {nextRewardLabel}</p>
            </div>
          )}
        </motion.button>
        ...
        <Link href="/missions" className="block">
          ...
          >
            <div className="flex items-start justify-between mb-2">
              ...
              <span className="text-[8px] font-bold px-1.5 py-0.5 rounded-full" style={{ background: 'rgba(59,130,246,0.15)', color: '#93c5fd', border: '1px solid rgba(59,130,246,0.25)' }}>
                DIÁRIAS
              </span>
            </div>

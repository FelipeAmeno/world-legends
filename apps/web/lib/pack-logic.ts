...
export const PACK_DEFS: readonly PackDefinitionUI[] = [
  {
    ...
    name:'Classic Pack', tagline:'Clássicos de todas as eras',
    price:150, cardCount:5, guarantee:'Mínimo 1 Rara',
    gradientFrom:'#1a1f2e', gradientTo:'#0d0f17',
    borderColor:'rgba(147,51,234,0.4)', glowColor:'rgba(147,51,234,0.35)',
    icon:'📦',
  },
  {
    id:'elite', pack:ELITE_PACK,
    name:'Elite Pack', tagline:'Os melhores do mundo',
    price:400, cardCount:5, guarantee:'Mínimo 2 Elites',
    gradientFrom:'#0a1628', gradientTo:'#060d1a',
    borderColor:'rgba(59,130,246,0.5)', glowColor:'rgba(59,130,246,0.4)',
    icon:'⚡',
  },
  {
    id:'legend', pack:LEGEND_PACK,
    name:'Legend Pack', tagline:'Lendas imortais do futebol',
    price:1000, cardCount:3, guarantee:'Mínimo 1 Lendária',
    gradientFrom:'#211500', gradientTo:'#0d0800',
    borderColor:'rgba(201,168,76,0.6)', glowColor:'rgba(201,168,76,0.5)',
    icon:'👑',
  },
];

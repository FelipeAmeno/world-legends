...
export const EASE = {
  ...
  smooth: [0.22, 1.0, 0.36, 1], // fluido — modais, drawers
  out: [0.16, 1.0, 0.3, 1], // snappy — entradas de tela
  in: [0.55, 0.0, 1.0, 0.45], // acelerado — saídas de tela
  inOut: [0.87, 0.0, 0.13, 1.0], // simétrico — progress bars
  linear: [0.0, 0.0, 1.0, 1.0], // progresso linear
} as const;
...
export const VARIANTS = {
  ...
  scale: {
    ...
    exit: {
      opacity: 0,
      scale: 0.96,
      transition: { duration: DURATION.exit / 1000, ease: EASE.in },
    },
  },
